...
class QbzxLevelDamageImgModel extends Model
{
	...
	protected $_validate = array(
			...
			array('damage_picture','require','残损照片不能为空',self::EXISTS_VALIDATE),//存在即验证，不能为空
			array('damage_picture','1,255','残损照片长度不能超过255个字符',self::EXISTS_VALIDATE,'length'), //存在即验证，长度不能超过255个字符
	);
}