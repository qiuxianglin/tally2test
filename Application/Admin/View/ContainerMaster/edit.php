		  ...
		  <table class="frame_form" cellpadding="0" cellspacing="0" width="45%">
		    <tbody>
		      <tr>
		        ...
		        <td>
		          <input class="input fl" type="text" name="containerMasterCode" id="code" size="25" value="{$msg['ctn_master_code']}">
		      ...
		      <tr>
		        <th>箱主名称：</th>
		        <td>
		          <input class="input fl" type="text" name="containerMaster" id="name" size="25" value="{$msg['ctn_master']}">
		          <em class="error tips">必须填</em>
		        </td>
		      </tr>
		      <tr>
		        <th></th>
		        <td>
		          <input type="submit" value="编辑箱主" class="sub">
