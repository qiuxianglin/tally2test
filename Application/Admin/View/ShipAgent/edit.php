		  ...
		  <table class="frame_form" cellpadding="0" cellspacing="0" width="45%">
		    <tbody>
		      ...
		      <tr>
		        <th>企业代码：</th>
		        <td>
		          <input class="input fl" type="text" name="enterprise_code" size="25" value="{$msg['enterprise_code']}">
		        </td>
		      </tr>
		      <tr>
		        <th>地址：</th>
		      ...
		      <tr>
		        <th>邮编：</th>
		        <td>
		          <input class="input fl" type="text" name="postcode" size="25" value="{$msg['postcode']}">
		        </td>
		      </tr>
		      <tr>
		        <th>联系人：</th>
		      ...
		      <tr>
		        <th>传真：</th>
		        <td>
		          <input class="input fl" type="text" name="fax" size="25" value="{$msg['fax']}">
		        </td>
		      </tr>
		      <tr>
		        <th>电传：</th>
		        <td>
		          <input class="input fl" type="text" name="telex" size="25" value="{$msg['telex']}">
		        </td>
		      </tr>
		      <tr>
		        <th>邮箱：</th>
		        <td>
		          <input class="input fl" type="text" name="email" size="25" value="{$msg['email']}">
		        </td>
		      </tr>
		      <tr>
		        <th>备注：</th>
		      ...
		      <tr>
		        <th></th>
		        <td>
		          <input type="submit" value="编辑船代" class="sub">
