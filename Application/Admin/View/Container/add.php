		  ...
		  <table class="frame_form" cellpadding="0" cellspacing="0" width="45%">
		    <tbody>
		      <tr>
		        ...
		        <td>
		          <input class="input fl" type="text" name="ctn_type_code" id="code" size="25">
		      ...
		      <tr>
		        <th>箱型：</th>
		        <td>
		          <input class="input fl" type="text" name="ctn_type" id="type" size="25">
		          <em class="error tips">必须填</em>
		        </td>
		      </tr>
		      <tr>
		        <th>箱尺寸：</th>
		        <td>
		          <input class="input fl" type="text" name="ctn_size" id="size" size="25">
		          <em class="error tips">必须填</em>
		        </td>
		      </tr>
		      <tr>
		        <th></th>
		        <td>
		          <input type="submit" value="新增箱型" class="sub">
