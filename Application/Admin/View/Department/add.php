		  ...
		  <table class="frame_form" cellpadding="0" cellspacing="0" width="45%">
		    <tbody>
		      <tr>
		        ...
		        <td>
		          <input class="input fl" type="text" name="department_code" id="code" size="25">
		      ...
		      <tr>
		        <th>部门名称：</th>
		        <td>
		          <input class="input fl" type="text" name="department_name" id="name" size="25">
		          <em class="error tips">必须填</em>
		        </td>
		      </tr>
		      <tr>
		        ...
		        <td>
		          <select name="pid">
		            ...
		            {
		            	echo '<option value="'.$dl['id'].'">'.$dl['department_name'].'</option>';
		            }
		            ?>
		          </select> 
		        </td>
		      ...
		      <tr>
		        <th></th>
		        <td>
		          <input type="submit" value="新增部门" class="sub">
