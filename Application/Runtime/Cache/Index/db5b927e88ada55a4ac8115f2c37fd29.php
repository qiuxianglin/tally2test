...
<body>
	<div class="tanchuang">
		<form action="/tally2test/index.php?s=/QbzxOperation/editlevel" method="post">
			...
			<table border="0">
				<tr>
					...
					<td> 
					  <input type="text" class="article" name="billno" required="required" value="<?php echo ($msg['billno']); ?>" />
				    </td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">货物件数：</td>
					<td>
					   <input type="text" class="article" name="cargo_number" required="required" value="<?php echo ($msg['cargo_number']); ?>" />
					</td>
				</tr>
				<tr>
