	...
	<div class="tanchuang">
		<form action="__ACTION__/instruction_id/{$instruction_id}" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="36" align="right" valign="middle">运输单号：</td>
					<td>
					  <input type="text" class="article" name="crgno"/>					
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" class="article" name="mark"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">重量：</td>
					<td><input type="text" class="article" name="totalweight" /></td>
				</tr>
				<tr>
			   ...
			   <tr>
					...
					<td>
					  <input type="text" class="article" name="totalvolume" />					
					</td>
				</tr>
			   <tr>
					<td height="36" align="right" valign="middle">PO号：</td>
					<td>
					  <input type="text" class="article" name="po"/>					
					</td>
				</tr>
			   <tr>
					<td height="36" align="right" valign="middle">备注：</td>
					<td>
					<textarea style="width:250px;height:50px" class="article" name="remark"></textarea>					
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
