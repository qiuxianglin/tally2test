	        ...
	        <hr style="width:300px;margin:5px auto;background:#abcdef;height:2px;">
  			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td>
					    <input type="text" class="article" name="ctnno" required="required" style="width:137px;"/>
					</td>
				</tr>
				<tr>
					<td width="195" height="46" align="right" valign="middle">箱型尺寸：</td>
					<td>
					  <select name="ctn_size" class="article" style="width: 137px" required="required">
				...
				<tr>
					...
					<td>
					    <input type="text" class="article" name="pre_number" style="width:137px;"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
