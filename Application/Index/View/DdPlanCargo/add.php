		...
		<form action="__ACTION__" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td><input type="text" class="article" style="width:150px" name="cargoname" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">件数：</td>
					<td><input type="text" class="article" style="width:150px" name="number" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">包装：</td>
					<td><input type="text" class="article" style="width:150px" name="package" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">标志：</td>
					<td><input type="text" class="article" style="width:150px" name="mark" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">收货人：</td>
					<td><input type="text" class="article" style="width:150px" name="consignee" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">联系人：</td>
					<td><input type="text" class="article" style="width:150px" name="contactuser" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">联系方式：</td>
					<td><input type="text" class="article" style="width:150px" name="contact" required="required"/></td>
				</tr> 
				<tr>
					<td height="36" align="right" valign="middle">联合国编号：</td>
					<td><input type="text" class="article" style="width:150px" name="undgno" required="required"/></td>
				</tr>
				<tr>
					<td height="36" align="right" valign="middle">危险品等级：</td>
					<td><input type="text" class="article" style="width:150px" name="classes" required="required"/></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>
